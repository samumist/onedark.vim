...
call s:h("QuickFixLine", { "fg": s:black, "bg": s:blue }) " Current quickfix item in the quickfix window.
...
call s:h("jsObjectValue", { "fg": s:green })
call s:h("jsObjectProp", { "fg": s:red })
call s:h("jsDestructuringBlock", { "fg": s:red, "gui": "italic" })
call s:h("jsDestructuringPropertyValue", { "fg": s:red, "gui": "italic" })
...
call s:h("pythonBuiltinType", { "fg": s:cyan})
call s:h("pythonBuiltinObj", { "fg": s:dark_yellow})
...
call s:h("pythonAssignment", { "fg": s:white})
